...
void main (void){
    ...
    float fog_factor = 1.0 / exp(center_point_distance * fog_density * (1.0 - segment_fog_factor) * (1.0 - segment_fog_factor) * (1.0 - segment_fog_factor) * (1.0 - segment_fog_factor));
